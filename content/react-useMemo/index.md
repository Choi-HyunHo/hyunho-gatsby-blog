...
그 이유는 자바스크립트에서 <span style='background-color : #fff5b1'>**객체**</span>는 원시 타입과는 다르게 <span style='background-color : #fff5b1'>**값이 저장될 때 주소 값으로 저장**</span>되기 때문 입니다. ➡️ [불변성이란](https://choi-hyunho.com/react-immutability/)
